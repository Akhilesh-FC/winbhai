...
class UserController extends Controller
{
    ...
    public function paymode_show()
    {
        ...
        return view('paymode.index', compact('payModes'));
    }
...
//         return view('user.demo1_user', compact('demo_user'));
...
//       }
	...
	public function wallet_subtractold(Request $request, $id)
    {
    date_default_timezone_set('Asia/Kolkata');
    ...
    public function wallet_subtract(Request $request, $id)
    {
        ...
        // DB::insert("
        //     INSERT INTO `payouts`(`user_id`, `cash`, `type`, `status`, `created_at`) 
        //     VALUES (?, ?, 'Admin Subtract', '1', ?)
        // ", [$id, $amount, date('Y-m-d H:i:s')]);
