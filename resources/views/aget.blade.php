                ...
                <div class="modal-body ml-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="10">
                                <label class="form-check-label"> Aviator History</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="11">
                                <label class="form-check-label">Dragon Tiger</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="12">
                                <label class="form-check-label">Dragon History</label>
                            </div>
                            <div class="form-check">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="16">
                                <label class="form-check-label">Withdraw</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="17">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permissions[]" value="19">
                                <label class="form-check-label">Support Settings</label>
                            </div>
                            <div class="form-check">
