...
<html>
<head>
    <title>Agent User Dashboardfff</title>
...
<div class="content-wrapper-fixed">
                ...
                <tr>
                    ...
                    <td>
                        @if($g->status == 0)
                            <span class="status-pill pending">Pending</span>
                        @elseif($g->status == 1)
                            <span class="status-pill win">Win</span>
                        @else
                            <span class="status-pill loss">Loss</span>
                        @endif
                    </td>
                    <td>{{ $g->created_at }}</td>
                </tr>
    ...
    {{-- ⭐ DRAGON & TIGER --}}
    <div class="card">
        <h3>DRAGON & TIGER BET HISTORY</h3>
